...
const AdminOperations = () => {
    ...
    return (
        <div className='h-[100vh] w-full flex flex-col px-5'>
            ...
            <button className='w-[6rem] border p-2 rounded-xl ' onClick={togglemodal} >Add </button>
            <h1 className='w-full  text-2xl my-3'>present: {params.operation}</h1>
            <div
                className="relative flex flex-col  text-white  shadow-md rounded-xl bg-clip-border">
