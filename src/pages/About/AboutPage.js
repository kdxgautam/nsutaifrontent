  ...
  return (
    <>
      <main className="overflow-hidden">
        ...
        <div className="md:flex items-center justify-center md:hidden md:max-xl:hidden xl:hidden ">
          <DepartmentsMob />
        </div>
        <div className="text-center pt-36 pb-12">
          <h1 className="text-xl text-[#BBBCC0] font-inter font-normal md:max-xl:text-md">
        ...
        <div className="flex justify-center items-center gap-2 xl:px-[33rem] font-light md:max-xl:text-sm px-[2rem] md:max-xl:px-[2rem] pb-[4rem] ">
          <div className="hover:bg-[#415ED0] cursor-pointer rounded-2xl text-[0.5rem] sm:text-[0.8rem] w-[7rem] xl:w-[16rem] xl:h-[1.8rem] text-center pt-1">
            Software Department
          </div>
          <div className="hover:bg-[#415ED0] cursor-pointer rounded-2xl text-[0.5rem] sm:text-[0.8rem] w-[7rem] xl:w-[16rem] xl:h-[1.8rem] text-center pt-1">
            Research Department
          </div>
          <div className="hover:bg-[#415ED0] cursor-pointer rounded-2xl text-[0.5rem] sm:text-[0.8rem] w-[3rem] xl:w-[4rem]  xl:h-[1.8rem] text-center pt-1">
            All
          </div>
          <div className="hover:bg-[#415ED0] cursor-pointer rounded-2xl text-[0.5rem] sm:text-[0.8rem] w-[7rem] xl:w-[16rem] xl:h-[1.8rem] text-center pt-1">
            AI&ML Department
