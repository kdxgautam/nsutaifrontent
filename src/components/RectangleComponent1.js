...
const RectangleComponent1 = () => {
  return (
    <footer className="h-[17.94rem] relative flex flex-row items-end justify-start pt-[4.56rem] px-[5.94rem] pb-[4.38rem] box-border gap-[22.69rem] tracking-[normal] text-center text-[1.25rem] text-gray-200 font-inter lg:gap-[22.69rem] lg:pl-[2.94rem] lg:pr-[2.94rem] lg:box-border mq450:gap-[22.69rem] mq750:gap-[22.69rem] mq750:pl-[1.44rem] mq750:pr-[1.44rem] mq750:box-border">
      <section className="h-full  absolute flex flex-wrap justify-between my-0 mx-[!important] top-[0rem] right-[0rem] bottom-[0rem] left-[0rem] bg-gainsboro" />
      <div className="h-[5rem] flex flex-col items-start justify-start pt-[0rem] pb-[0.5rem] pr-[2.5rem] pl-[0rem] box-border max-w-full text-left">
        <div className="flex-1 flex flex-row items-start justify-start relative">
          <img
            ...
            src="/white-1@2x.png"
          />
          <div className="self-stretch relative text-[bisque] z-[2]">
            <p className="m-0">All trademarks, logos, and brand names are</p>
            <p className="m-0">property of their respective owners.</p>
          </div>
        </div>
      </div>
      <div className="w-[13.88rem] relative text-[1rem] text-[bisque]  inline-block shrink-0 z-[1]">
      ...
      <div className="w-[15.25rem] flex flex-col items-start justify-start pt-[0rem] px-[0rem] pb-[0.5rem] box-border text-[1.5rem] text-white">
        <div className="self-stretch flex flex-col items-start justify-start gap-[4.19rem]">
          ...
          <div className="flex flex-row items-start justify-start relative text-gray-200">
